...
exports.addSubscription = async (req, res) => {
    ...
    if (!subscriptionName || !subscriptionPrice || !subscriptionFeatures) {
        res.status(404).json({
...
exports.updateSubscription = async (req, res) => {
    ...
    if (!subscriptionid || !subscriptionName || !subscriptionPrice || !subscriptionFeatures) {
        res.status(404).json({
